(function (global, factory) {
  ...
  _export(
    { target: "Array", proto: true, forced: ES3_STRINGS || SLOPPY_METHOD$1 },
    {
  ...
  // https://tc39.github.io/ecma262/#sec-parsefloat-string
  _export(
    { global: true, forced: parseFloat != _parseFloat },
    {
  ...
  var Utils = {
    ...
    setFieldIndex: function setFieldIndex(columns) {
      ...
      try {
        for (
          var _iterator2 = columns[0][Symbol.iterator](), _step2;
      ...
      for (var _i = 0; _i < columns.length; _i++) {
        ...
        try {
          for (
            var _iterator3 = columns[_i][Symbol.iterator](), _step3;
    ...
    updateFieldGroup: function updateFieldGroup(columns) {
      ...
      try {
        for (
          var _iterator4 = columns[Symbol.iterator](), _step4;
          ...
          try {
            for (
              var _iterator5 = c[Symbol.iterator](), _step5;
    ...
    calculateObjectValue: function calculateObjectValue(
      ...
      if (typeof name === "string") {
        ...
        if (names.length > 1) {
          ...
          try {
            for (
              var _iterator6 = names[Symbol.iterator](), _step6;
    ...
    getItemField: function getItemField(item, field, escape) {
      ...
      try {
        for (
          var _iterator7 = props[Symbol.iterator](), _step7;
    ...
    findIndex: function findIndex(items, item) {
      ...
      try {
        for (
          var _iterator8 = items[Symbol.iterator](), _step8;
        ...
        },
        {
          ...
          value: function initData(rows, num) {
            ...
            var bottomOffset = Math.max(
              (rows.length - end) * this.itemHeight,
              0
            );
            var thisRows = [];
            var rowsAbove = start;
      ...
      _createClass(BootstrapTable, [
        ...
        },
        {
          ...
          value: function initTable() {
            ...
            if (!this.options.data.length) {
              this.options.data = Utils.trToData(
                this.columns,
        ...
        },
        {
          ...
          value: function initHeader() {
            ...
            this.options.columns.forEach(function (columns, i) {
              ...
              if (
                i === 0 &&
                !_this2.options.cardView &&
                _this2.options.detailView &&
                _this2.options.detailViewIcon
              ) {
                html.push(
                  '<th class="detail" rowspan="'.concat(
                    _this2.options.columns.length,
              ...
              columns.forEach(function (column, j) {
                ...
                if (headerStyle && headerStyle.css) {
                  for (
                    var _i = 0,
                      _Object$entries = Object.entries(headerStyle.css);
                ...
                html.push(
                  "<th".concat(
                    Utils.sprintf(' title="%s"', column.titleTooltip)
                  ),
            ...
            this.$container
              ...
              .on("click", ".th-inner", function (e) {
                ...
                if (
                  ...
                  if (
                    $this.closest(".bootstrap-table")[0] !==
                    _this2.$container[0]
                  ) {
                    return false;
                  }
          ...
          value: function initToolbar() {
            ...
            var buttonsHtml = {
              paginationSwitch: '<button class="'
                ...
                .concat(opts.formatPaginationSwitch(), '">\n        ')
                .concat(
              ...
              toggle: '<button class="'
                ...
                .concat(opts.formatToggle(), '">\n        ')
                .concat(
                  opts.showButtonIcons
                    ? Utils.sprintf(
                        this.constants.html.icon,
                        opts.iconsPrefix,
                        opts.icons.toggleOff
                      )
                    : "",
                  "\n        "
                )
              ...
              fullscreen: '<button class="'
                ...
                .concat(opts.formatFullscreen(), '">\n        ')
                .concat(
                  opts.showButtonIcons
                    ? Utils.sprintf(
                        this.constants.html.icon,
                        opts.iconsPrefix,
                        opts.icons.fullscreen
                      )
                    : "",
                  "\n        "
                )
              ...
              columns: (function () {
                ...
                _this4.columns.forEach(function (column, i) {
                  ...
                  var disabled =
                    visibleColumns <= _this4.options.minimumCountColumns &&
                    checked
                      ? ' disabled="disabled"'
                      : "";
            ...
            try {
              for (
                var _iterator = opts.buttonsOrder[Symbol.iterator](), _step;
                !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
                _iteratorNormalCompletion = true
              ) {
            ...
            if (opts.search || this.showSearchClearButton) {
              ...
              var handleInputEvent = function handleInputEvent() {
                var eventTriggers = "keyup drop blur ".concat(
                  Utils.isIEBrowser() ? "mouseup" : ""
                );
                $searchInput
                  .off(eventTriggers)
                  .on(eventTriggers, function (event) {
          ...
          value: function initSearch() {
            ...
            if (this.options.sidePagination !== "server") {
              ...
              var f = Utils.isEmptyObject(this.filterColumns)
                ? null
                : this.filterColumns; // Check filter
              ...
              if (typeof this.filterOptions.filterAlgorithm === "function") {
                ...
                typeof this.filterOptions.filterAlgorithm === "string"
              ) {
                this.data = f
                  ? this.options.data.filter(function (item, i) {
                      var filterAlgorithm =
                        _this5.filterOptions.filterAlgorithm;
              ...
              this.data = s
                ? this.data.filter(function (item, i) {
                    for (var j = 0; j < _this5.header.fields.length; j++) {
                      ...
                      var column =
                        _this5.columns[_this5.fieldsColumnsIndex[key]];
                      var value = void 0;
        ...
        },
        {
          ...
          value: function initPagination() {
            ...
            var paginationInfo = opts.onlyInfoPagination
                ...
                if (to + 1 === min - 1) {
                  ...
                  if (min > to + 1) {
                    if (
                      ...
                      i = Math.round(
                        (this.totalPages - middleSize - to) / 2 + to
                      );
                      html.push(pageItem(i, " page-intermediate"));
                    } else {
                      html.push(
        ...
        },
        {
          ...
          value: function initRow(item, i, data, trFragments) {
            ...
            if (style && style.css) {
              for (
                var _i3 = 0, _Object$entries2 = Object.entries(style.css);
                _i3 < _Object$entries2.length;
                _i3++
              ) {
                var _Object$entries2$_i = _slicedToArray(
                    _Object$entries2[_i3],
                    2
                  ),
            ...
            if (attributes) {
              for (
                var _i4 = 0, _Object$entries3 = Object.entries(attributes);
            ...
            if (item._data && !Utils.isEmptyObject(item._data)) {
              for (
                var _i5 = 0, _Object$entries4 = Object.entries(item._data);
            ...
            this.header.fields.forEach(function (field, j) {
              var text = "";
              var value_ = Utils.getItemField(
                item,
                field,
                _this7.options.escape
              );
              var value = "";
              var type = "";
              var cellStyle = {};
              ...
              if (cellStyle.css) {
                ...
                for (
                  var _i6 = 0, _Object$entries5 = Object.entries(cellStyle.css);
                  _i6 < _Object$entries5.length;
                  _i6++
                ) {
                  var _Object$entries5$_i = _slicedToArray(
                      _Object$entries5[_i6],
                      2
                    ),
          ...
          value: function initBodyEvent() {
            ...
            this.$body
              ...
              .on("click dblclick", function (e) {
                ...
                var field =
                  fields[
                    _this9.options.detailView &&
                    _this9.options.detailViewIcon &&
                    !_this9.options.cardView
                      ? index - 1
                      : index
                  ];
            ...
            this.$body
              ...
              .on("click", function (e) {
                ...
                _this9.toggleDetailView(
                  $(e.currentTarget).parent().parent().data("index")
                );
          ...
          value: function getCaret() {
            ...
            this.$header.find("th").each(function (i, th) {
              $(th)
                ...
                .addClass(
                  $(th).data("field") === _this11.options.sortName
        ...
        },
        {
          ...
          value: function updateRows() {
            ...
            this.$selectItem.each(function (i, el) {
              _this12.data[$(el).data("index")][_this12.header.stateField] =
                $(el).prop("checked");
            });
          },
        },
        {
          ...
          value: function resetRows() {
            ...
            try {
              for (
                var _iterator2 = this.data[Symbol.iterator](), _step2;
        ...
        },
        {
          ...
          value: function fitHeader() {
            ...
            this.$header.find("th[data-field]").each(function (i, el) {
              _this14.$header_
                .find(Utils.sprintf('th[data-field="%s"]', $(el).data("field")))
                .data($(el).data());
            });
            var visibleFields = this.getVisibleFields();
            ...
            $tr.find("> *").each(function (i, el) {
              ...
              if (
                _this14.options.detailView &&
                _this14.options.detailViewIcon &&
                !_this14.options.cardView
              ) {
                if (i === 0) {
        ...
        },
        {
          ...
          value: function initFooter() {
            ...
            try {
              for (
                var _iterator3 = this.columns[Symbol.iterator](), _step3;
                ...
                if (style && style.css) {
                  for (
                    var _i8 = 0, _Object$entries7 = Object.entries(style.css);
                ...
                html.push(
                  Utils.calculateObjectValue(
                    ...
                    [data],
                    (this.footerData[0] && this.footerData[0][column.field]) ||
                      ""
                  )
                );
                html.push("</div>");
        ...
        },
        {
          ...
          value: function getVisibleFields() {
            ...
            try {
              for (
                var _iterator4 = this.header.fields[Symbol.iterator](), _step4;
        ...
        },
        {
          ...
          value: function updateRow(params) {
            ...
            try {
              for (
                var _iterator5 = allParams[Symbol.iterator](), _step5;
        ...
        },
        {
          ...
          value: function updateByUniqueId(params) {
            ...
            try {
              for (
                var _iterator6 = allParams[Symbol.iterator](), _step6;
        ...
        },
        {
          ...
          value: function getHiddenRows(show) {
            ...
            try {
              for (
                var _iterator7 = data[Symbol.iterator](), _step7;
        ...
        },
        {
          ...
          value: function _toggleCheck(checked, index) {
            ...
            if (
              ...
              try {
                for (
                  var _iterator9 = this.options.data[Symbol.iterator](), _step9;
        ...
        },
        {
          ...
          value: function resetView(params) {
            ...
            if (this.$container.hasClass("fullscreen")) {
              ...
              var height =
                this.options.height - toolbarHeight - paginationHeight;
        ...
        },
        {
          ...
          value: function filterBy(columns, options) {
            this.filterOptions = Utils.isEmptyObject(options)
              ...
              : $.extend(this.options.filterOptions, options);
        ...
        },
        {
          ...
          value: function expandRow(index, _columnDetailFormatter) {
            ...
            var $tr = this.$body.find(
              Utils.sprintf(
                '> tr[data-index="%s"][data-has-detail-view]',
                index
              )
            );
