...
CREATE TABLE IF NOT EXISTS `CourseInfo` (
    ...
    CONSTRAINT `CouTeacherNo` FOREIGN KEY (`TeacherNo`) REFERENCES `TeacherInfo` (`TeacherNo`) ON DELETE
    SET NULL ON UPDATE CASCADE,
        CONSTRAINT `CouClassroomNo` FOREIGN KEY (`ClassroomNo`) REFERENCES `ClassroomInfo` (`ClassroomNo`) ON DELETE
    SET NULL ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS `ExamInfo` (
    ...
    CONSTRAINT `ExaClassroomNo` FOREIGN KEY (`ClassroomNo`) REFERENCES `ClassroomInfo` (`ClassroomNo`) ON DELETE
    SET NULL ON UPDATE CASCADE,
